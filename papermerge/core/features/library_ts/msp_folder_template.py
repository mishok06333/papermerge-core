    ...
    (
        ...
        [
            (
                ...
                [
                    (
                        "расчет среднедушевого дохода семьи (при необходимости)",
                        [],
                    ),
                ],
            ),
            (
                "Срок осуществления выплаты (при предоставлении МСП в денежной форме)",
                [],
            ),
            (
                "Процедура предоставления (выдачи) МСП (ТСР, КМСК, РМСК, удостоверения, путевки, комплект для новорожденного)",
                [],
            ),
